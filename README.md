...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/wcmatch-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11469&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/wcmatch-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `wcmatch` can be installed with:

```
conda install wcmatch
```

It is possible to list all of the versions of `wcmatch` available on your platform with:
